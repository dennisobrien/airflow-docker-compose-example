...
#
#RUN pip install -e git://github.com/dennisobrien/incubator-airflow.git@6aef967960207b9d0e472cb84b1112d1dc959139#egg=airflow[celery,crypto,hive,jdbc,ldap,password,postgres,s3,vertica]
#
